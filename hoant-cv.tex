...
\extrainfo{DoB: December 22,1993}                 % optional, remove / comment the line if not wanted
...
%\begin{picture}(0,0)
%\put(380,-60){\includegraphics[scale=0.35]{picture}}
%\end{picture}
%-----       resume       ---------------------------------------------------------
\makecvtitle
...
\cventry{2016 - present}{Master Degree}{University of Information Technology - VNU-HCM}{Ho Chi Minh City}{\textit{GPA: \textbf{8.97}/10}}{Major: Computer Science}

\section{Research Interest and Objective}
\cvitem{Principal research interests}{\emph{future networks, SDN, network security}}
...
\subsection{Teaching}
\begin{itemize}
	\item Teaching Assistant and Instructor for network and security courses:
	\begin{itemize}
...
\begin{itemize}
	...
	\item Mentor of two \textit{Student Academic Club} about Information Security and Network.
\end{itemize}
}
